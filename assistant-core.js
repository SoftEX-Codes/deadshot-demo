...
const handoff = 'I can’t confirm that from the catalogue. Ask MCOD GADGET STORE on WhatsApp for a reliable answer.';
export function answerQuestion(question, devices, lastId = '') {
  ...
  if(/\b(contact|whatsapp|human|employee|person|help)\b/.test(q))return result('Speak with MCOD GADGET STORE on WhatsApp: +2349038237257.',[],true);
