...
const head=make('div','assistant-head'),heading=make('div');const title=make('h2','','DEADSHOT CHAT');title.id='assistant-title';heading.append(title,make('p','','Phone questions. Straight answers.'));
