...
const head=make('div','assistant-head'),heading=make('div');const title=make('h2','','MOXIE GADGETS CHAT');title.id='assistant-title';heading.append(title,make('p','','Phone questions. Straight answers.'));
...
async function ask(question){
  ...
  if(answer.refer){const a=make('a','chat-whatsapp','Ask on WhatsApp · +234 907 642 0186');a.href='https://wa.me/2349076420186?text='+encodeURIComponent('Hi Moxie Gadgets, I need help with: '+q);a.target='_blank';a.rel='noopener noreferrer';reply.append(a);}
